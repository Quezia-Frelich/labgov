export const beneficios = [
  {
   titulo: "ACATE Smart Cities",
    descricao: "A Vertical Smart Cities é composta por mais de 110 empresas de tecnologia que pensam e criam cidades mais dinâmicas, sustentáveis e eficientes, integrando também representantes de governos, academia e da sociedade civil.Reúne empresas com soluções nas áreas de Conectividade, Dados, Sustentabilidade Urbana, Mobilidade, Turismo, Governo Digital, entre outros.",
    urlLogo: "/empresas/Smart-Cities.png",
  ...
  },
  {
    ...
    descricao: "O INOVAGOV é um programa, firmado por meio de acordo de cooperação técnica entre os poderes e órgãos estaduais, com a finalidade de promover o fomento e o apoio na execução de projetos e adoção de práticas inovadoras no âmbito governamental, para conferir mais eficiência, eficácia e efetividade à gestão pública e na prestação de serviços às pessoas.",
    urlLogo: "/empresas/Inovagov.png",
    link: "https://inovagovsc.org/"
  },
  {
    titulo: "FEPESE",
