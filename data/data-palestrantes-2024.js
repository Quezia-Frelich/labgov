export const data_palestrantes_2024 = [
      ...
      },
    {
      ...
      },
      {
        ...
        description: 'Éder Pinheiro é CTO da Mip Wise, com mestrado em Engenharia de Produção e bacharelado em Matemática e Computação Científica pela UFSC. Com passagem pela WPLEX e Mercado Livre, ele possui vasta experiência em otimização e automação de processos. Na Mip Wise, lidera o desenvolvimento de soluções tecnológicas para melhorar a eficiência industrial e logística.',
        instagram: '',
      ...
      },
      {
        ...
        description: 'Engenheiro Civil (1995), Mestre em Estruturas (2004). Diretor de Portfolio na AltoQi Tecnologia, empresa que atua há 35 anos no desenvolvimento de software para projetos em BIM. É presidente do BIM Fórum Brasil, Chair da buildingSMART Brasil e Coordenador Técnico do Projeto Construa Brasil.',
        instagram: '',
      ...
      },
      {
        ...
        description: 'Eng.º Civil - Universidade Estadual PR, Especialista em Estruturas - USP, Especialista em Centrais Hidrelétricas - UNIFEI-MG, Mestrado em Estruturas - PUC-RJ, Professor Universitário, foi Eng. de Projetos de Geração de Energia e Diretor de Operação da ELETROSUL',
      ...
      },
    {
        ...
        description: 'Fundador/CEO do FazendaCheia e atual Diretor da Vertical Agtech ACATE. É especialista em Gestão de Projetos e Mestre em Engenharia e Gestão do Conhecimento com mais de 15 anos de experiência em desenvolvimento e gestão de projetos de software.',
